...
export default class ObjectProperty<Computed extends boolean = boolean, Shorthand extends boolean = boolean> implements ASTBase {
    ...
    constructor(public key: Computed extends true ? ASTExpression.Any : Identifier, public value: Shorthand extends true ? Identifier : ASTExpression.Any, public location: LocationPoints) {}
}